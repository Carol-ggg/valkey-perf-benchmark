-- ========================================
-- Local EC2 Postgres Setup for Valkey Benchmark
-- ========================================
-- Run as the postgres superuser:
--   sudo -u postgres psql -f localEC2_schema.sql
--
...
--
-- Creates one user:
-- 1. github_actions - password-auth user for GitHub Actions runner
--    (RDS IAM auth removed; local Postgres uses scram-sha-256/md5 password auth)
-- ========================================
...
-- (RDS-only) GRANT rds_iam TO github_actions; -- not applicable on local Postgres
...
SELECT 'Created users: postgres (Admin with full access), github_actions (password-auth)' as users;
